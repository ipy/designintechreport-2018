...
* ![](https://raw.githubusercontent.com/johnmaeda/designintechreport-2018/master/asset/image/takram.jpg)
	Takram<br>
	日本語
* ![](https://avatars1.githubusercontent.com/u/2088040)
	Sin<br>
	简体中文
]
...
# .xx-large.serif[桌面优先 / Beta 版本须知]

.x-large.sans[我本来打算以一种聪明的——移动优先和响应式的方式——来设计这个报告......但我被这堆代码搞得焦头烂额。周末黑客项目通常会出现这种情况（眨眼~）。如果你正通过手机访问——这非常有可能——请暂时忍耐一下。最终我会推出一个仅限移动设备的版本，我正在学习中！ —JM]
...
欢迎阅读全新格式的《科技中的设计》。对于今年的报告，我试着学习了一直想了解的 CSS/JS 所有相关知识，然后制作了一份完全响应式的报告。我在这条道路上取得了阶段性成功，产出了这个信箱专用的版本——这可比 PDF 好多了。另外感谢来自 Takram 的 Shota Matsuda，在他的帮助下这份报告得到了极大的改善。

如果看到 .refresh[必要时请刷新屏幕]，请刷新你的窗口，一个动态图表可能会重新显示出来。 使用 Chrome 浏览这份报告效果最佳。如果你不喜欢这样的互动版本，请访问 Slideshare 上的这个版本[**](https://www.slideshare.net/johnmaeda/design-in-tech-report-2018)。

未来我会把所有这些调查结果的视频版本发布到 “John Maeda is Learning” 这个新 YouTube 频道，敬请期待。
...
.grid.across-2[
.group[
### 1) TBD=科技(T)×商业(B)×设计(D)

在初创企业和企业生态系统中，科技、商业和设计如何相互关联？
]
.group[
### 2) 规模化设计

在摩尔定律的速度下，如何规模化公司中的设计能力以对商业产生影响？
]
.group[
### 3) 计算设计: 第一步

什么是“计算设计”？为什么它对商业+技术如此重要？
]
.group[
### 4) 计算设计 &times; A.I.

人工智能将如何改变设计的未来？设计师需要了解些什么？
]
.group[
### 5) 不平等

科技与不平等现象的加剧有什么关系？作为设计师，我们是否应该关注？
]
.group[
### 6) 为什么需要包容性设计

在考虑 TBD 时，是否需要更多地关心包容性设计？我可以为此做些什么？
]
]
...
.black.quote-list[
* 2004 至 2015 年期间，有 14 家创意公司被科技公司（包括 Facebook、伟创力、谷歌，还有埃森哲、Capital One、BBVA 和麦肯锡）非典型性地收购。
* 随着计算能力的边际收益减少（即摩尔定律），技术不再是差异化因素，设计的价值已经呈现到台前。
* 自 2010 年以来，有 27 家设计师联合创办的创业公司被 Intuit、谷歌、Facebook、Adobe、领英和雅虎这样的公司收购。
* 自 2013 年以来，获得额外融资的、有风投支持多轮融资的顶级企业中有五家（20％）的联合创始人中包括设计师。 已筹集额外资本的五家（20％）顶级累积融资风险投资支持企业被认为拥有设计师联合创始人。
*在 2014 年 1 月 Kleiner Perkins 提名其第一个设计合伙人 **John Maeda** 之前，硅谷传奇的“沙丘路”上没有设计师的存在。此后不久，六家风险投资公司邀请了新的设计合伙人。
* .purple.sans[.fas.fa-chart-line[] **DESIGN DE$IGN** 与桌面端相比，为移动端的设计产生了新的体验限制，这使得设计师的技能成为连接不懂技术的普通消费者的桥梁，变得非常有价值。]
]
]
.group[
...
.black.quote-list[
* 对设计公司的收购在继续：自 2004 年以来有 42 家设计公司被收购，其中仅去年一年就有约 50％。由埃森哲、德勤、IBM 带头。
* 风险投资行业的设计师的人数有所增加：过去两年，进入风投行业的设计师比前 4 年的总和还多。它的历史正被揭示出来。
 *受访的 370 名设计师中有 93.5％ 认为编写代码和面向数据的技能是技术设计师的筹码级知识。
...
* 前十大商学院中 100％ 都有学生主导的设计/创新俱乐部。哈佛商学院 2015 级学生中有 6-7％ 从事了产品管理相关工作。
* 设计系统和设计师文化成为了设计实现规模化的关键方法 —— 结论来自机构的实践和 Karl Gerstner 在设计项目中的开创性工作。
* 不要将多样性视为需要解决的问题，包容性设计正在成为经济上的机会和文化上的责任。
* .purple.sans[.fas.fa-chart-line[] **3 种设计** 有 3 种设计: 经典设计、设计思维和计算设计。大多数商业价值是由后两种设计驱动的。]
]
]
.group[
...
.black.quote-list[
* 根据领英的说法，对设计师的需求随着 Facebook、谷歌和亚马逊设计师招聘名额的增长一起增长，一年内增长了 65％。
* 麦肯锡和 Salesforce 通过更多的收购，对设计进行了非常大的投注。设计工具初创公司 InVision 收购了 5 家更小的初创公司。
...
* 设计工具的演化超越了 Photoshop 时代的印刷和早期网页设计范式，包含了原型设计、项目管理、版本控制、内嵌编码和自动化。
* 基于语音和聊天的界面，它们基于不需要视觉表现的心智模型。有关或无关的人工智能技术正在加速进步。
* 技术设计的趋势正在覆盖中国。中国的技术设计原理和实践在世界范围内处于领先地位，而且往往被忽视。
* 90％ 接受调查的设计师表示，拥有更多元化的设计团队对他们来说至关重要。他们公司内部的头号要求是：“进行更多的内部沟通。”
* .purple.sans[.fas.fa-chart-line[] **包容性设计的开始** 采用包容性设计方法可以扩大技术产品的潜在目标市场规模。包容性设计开始了重大的转折。]
]
]
]

.source[[《科技中的设计》](https://designintechreport.wordpress.com)]
.footer[欢迎]
...
.purple[设计不仅仅只关于美；它也有关市场适应性和有意义的结果。]

> .darkgray[_DESIGN 也是 DE$IGN — 历来就是这样，可以追溯到包豪斯时代或是更早。_]
]
.group[
.numeral.subhead[2016]

.purple[有 3 种设计: 经典设计、设计思维和计算设计。]

> .darkgray[_有 3 种设计: 经典设计、设计思维和计算设计。_]
]
.group[
.numeral.subhead[2017]

.purple[用包容性设计方法可以扩大技术产品的潜在目标市场规模。]

> .darkgray[_包容性是一个很好的商业机会。新的证据正在不断出现，随着包容性设计的实施会越来越多。_]
]
]

.source[过去的[《科技中的设计》](https://designintechreport.wordpress.com)]
.footer[欢迎]
...
.group[
* Slideshare 上有 800K+ 次浏览
* 视频/音频版本有超过 30K+ 次访问.
* *写作和它对设计的重要性* —— **Fatimah Kabba** 的一篇洞察 —— 目前是去年报告中最受欢迎的观点。
* 新主页 **designintechreport.wordpress.com** 的 SEO 工作完全停滞了。希望能获得你的支持和参与来继续进行，非常感谢！
]
]
...
* **Statler:** #DesignInTech 本身不是一个好的设计工作。”
* **Waldorf:** “我曾见过一次，但它的平面设计非常糟糕 :-)”
* **Statler:** “作为一个有关设计的表述，这就非常尴尬了。”
* **Waldorf:** “同意。”
]
</details>
]
...
* 设计不仅仅只关于美；它也有关市场适应性和有意义的结果。
* 有三种设计: 经典设计、设计思维和计算设计。
* 2017年，有 21 起对创意机构和设计师创立的初创企业的收购。
* 在美国的医学院，设计思维被纳入课程体系。
* 咨询公司不只是试图超越设计思维——它们正试图改变商业方式。
* 中国以惊人的规模和复杂度继续引领设计体验。
* 印度和拉丁美洲的市场正在推动设计思维和计算设计。从中我们可以学到很多东西。
* **B 世代（老人）** 正在成为新产品和新服务的市场机会，不容忽视。
]

.footer[科技 &times; 商业 &times; 设计]
...
驱动力/ 工业革命，以及之前至少几千年的发酵。
]
.group[
.cell-stack[
.numeral.subhead[02]
.small[
因为执行已经超越了创新，而且经验也很重要。
]
]
...
驱动力/ 同每个独立顾客需求的关系需要创新，它需要有同理心。
]
.group[
.cell-stack[
.numeral.subhead[03]
.small[
为数十亿独立个体进行设计，实时地进行设计。这正在不断发展，TBD 互相结合。
]
]
...
* The [Trans Pacific Partnership](https://www.nytimes.com/2018/03/08/world/asia/us-trump-tpp-signed.html) has been signed between 11 countries, and China is solidifying its ties with the region [来自 startups](https://www.bloomberg.com/news/articles/2018-03-04/chinese-startups-export-playbook-to-latin-america-for-new-riches).
...
.caption[来自 Computer History Museum]
]
...
.top.caption[来自 Max-Planck Institute]
]
</details>
]
.group[
...
.caption[来自 TechJobsTour in Paintsville, KY]
]
